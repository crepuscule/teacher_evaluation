...
public class EvaluationDao extends CommonDao {
    ...
    public Boolean add(Evaluation evaluation) {
        ...
        try {
            ...
            ps.setInt(4, evaluation.getT1() * 2);
            ps.setInt(5, evaluation.getT2() * 2);
            ps.setInt(6, evaluation.getT3() * 2);
            ps.setInt(7, evaluation.getT4() * 2);
            ps.setInt(8, evaluation.getT5() * 2);
            ps.setInt(9, evaluation.getT6() * 2);
            ps.setInt(10, evaluation.getT7() * 2);
            ps.setInt(11, evaluation.getT8() * 2);
            ps.setInt(12, evaluation.getT9() * 2);
            ps.setInt(13, evaluation.getT10() * 2);

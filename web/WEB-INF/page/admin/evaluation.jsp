...
<div class="container">
    ...
    <div class="row table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tbody><c:forEach items="${evaluations}" var="evaluation" varStatus="key"><tr><th>${key.count}</th><td>${evaluation.getTeacher().getName()}</td><td>${evaluation.getT1()}</td><td>${evaluation.getT2()}</td><td>${evaluation.getT3()}</td><td>${evaluation.getT4()}</td><td>${evaluation.getT5()}</td><td>${evaluation.getT6()}</td><td>${evaluation.getT7()}</td><td>${evaluation.getT8()}</td><td>${evaluation.getT9()}</td><td>${evaluation.getT10()}</td><td>${evaluation.getT1()}</td><td><fmt:formatDate value="${evaluation.getTime()}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td></tr></c:forEach></tbody>
        </table>
    </div>
</div>

...
CREATE TABLE `evaluation` (
    ...
    `t1`            TINYINT(2) UNSIGNED NOT NULL,
    `t2`            TINYINT(2) UNSIGNED NOT NULL,
    `t3`            TINYINT(2) UNSIGNED NOT NULL,
    `t4`            TINYINT(2) UNSIGNED NOT NULL,
    `t5`            TINYINT(2) UNSIGNED NOT NULL,
    `t6`            TINYINT(2) UNSIGNED NOT NULL,
    `t7`            TINYINT(2) UNSIGNED NOT NULL,
    `t8`            TINYINT(2) UNSIGNED NOT NULL,
    `t9`            TINYINT(2) UNSIGNED NOT NULL,
    `t10`           TINYINT(2) UNSIGNED NOT NULL,
